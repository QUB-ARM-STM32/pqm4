...
SRC_FILES := $(wildcard ../mupq/common/*.c) $(wildcard ../crypto_kem/$(SCHEME_NAME)/$(TYPE)/*.c) $(wildcard ../crypto_kem/$(SCHEME_NAME)/$(TYPE)/*.S) \
$(wildcard ../crypto_kem/$(SCHEME_NAME)/$(TYPE)/*.s) $(wildcard ../common/*.c) $(wildcard ../common/*.S) $(wildcard ../common/*.s)
...
build: clean
	if [ -d "../crypto_kem/$(SCHEME_NAME)/$(TYPE)" ]; then \
		echo "Building $(SCHEME_NAME)_$(TYPE)"; \
		$(CC) -c $(SRC_FILES) -I./common/ -I../mupq/common/ -I../crypto_kem/$(SCHEME_NAME)/$(TYPE)/ $(MPU); \
	else \
